package io.javabrains.apldashboard.data;
...
public class BatchConfig {
    ...
    public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Match>()
                ...
                .sql("INSERT INTO match (id, city, date, player_of_match, team1, team2, toss_winner, toss_decision, match_winner, result, result_margin, venue, umpire1, umpire2) "
                        + " VALUES (:id, :city, :date, :playerOfMatch, :team1, :team2, :tossWinner, :tossDecision, :matchWinner, :result, :resultMargin, :venue, :umpire1, :umpire2)")
